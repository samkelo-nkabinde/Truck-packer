...
public class TruckTest {
    ...
    public void testEmptyTruck() {
        Truck truck = new Truck("Test-Truck", 10, 4, 0.0); //trut 3
    ...
    public void testAddSingleItem() {
        Truck truck = new Truck("Test-Truck", 10, 5, 0.0); //tut 3
    ...
    public void testCombineIdenticalItems() {
        Truck truck = new Truck("Test-Truck", 10, 5, 0.0); // tut3 update
    ...
    public void testCannotExceedMaxVolume() {
        Truck truck = new Truck("Test-Truck", 10, 5, 0.0); // tut3 
    ...
    public void testCannotExceedIteamCap() {
        Truck truck = new Truck("Test-Truck", 20, 3, 0.0);
    ...
    public void testOldConstructorDefaults() {
        Truck truck = new Truck("T-Single", 10, 5, 0.0); 
